...
export type ImageUpdatesResponse = APISchemas['ImageUpdatesResponse']
...
export type CreateStackRequest = APISchemas['CreateStackRequest']
export type UpdateDefinitionRequest = APISchemas['UpdateDefinitionRequest']
export type UpdateDefinitionResponse = APISchemas['UpdateDefinitionResponse']
export type DeleteStackRequest = APISchemas['DeleteStackRequest']
export type ResolvedConfigPreviewRequest = APISchemas['ResolvedConfigPreviewRequest']
...
export type JobEnvelopeResponse = APISchemas['JobEnvelopeResponse']
export type JobDetailResponse = APISchemas['JobDetailResponse']
...
export type LogoutResponse = APISchemas['LogoutResponse']
export type UpdatePasswordRequest = APISchemas['UpdatePasswordRequest']
export type UpdatePasswordResponse = APISchemas['UpdatePasswordResponse']
...
export type ConfigFileSaveRequest = APISchemas['ConfigFileSaveRequest']
export type ConfigFileSaveResponse = APISchemas['ConfigFileSaveResponse']
export type ConfigFileDeleteRequest = APISchemas['ConfigFileDeleteRequest']
export type ConfigFileDeleteResponse = APISchemas['ConfigFileDeleteResponse']
...
export type StackWorkspaceFileSaveRequest = APISchemas['StackWorkspaceFileSaveRequest']
...
export type GitFileDeleteRequest = APISchemas['GitFileDeleteRequest']
export type GitFileDeleteResponse = APISchemas['GitFileDeleteResponse']
