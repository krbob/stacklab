...
describe('HostPage', () => {
  ...
  it('renders host overview cards and initial Stacklab logs', async () => {
    ...
    expect(within(processesRegion).getByText('server')).toBeInTheDocument()
    expect(within(processesRegion).getByText('stack minecraft')).toBeInTheDocument()
    expect(within(processesRegion).getByText('minecraft-server-1')).toBeInTheDocument()
