...
describe('MaintenancePage', () => {
  ...
  it('reviews the all-stack target, restart impact, snapshot, and recovery', () => {
    ...
    expect(review).toHaveTextContent('Stacks that are already active will be deployed again and services may restart.')
    expect(review).toHaveTextContent('Stopped and never-started stacks may pull or build images, but are not started.')
