  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-4 py-10">
      <section className="w-full max-w-xl rounded-[32px] border border-[var(--panel-border)] bg-[var(--panel)] p-8 text-center shadow-[var(--shadow)]">
        ...
        <h1 className="mt-4 text-4xl font-semibold tracking-[-0.05em] text-[var(--text)]">This route is outside the planned IA.</h1>
        <p className="mt-4 text-sm leading-6 text-[var(--muted)]">
          The scaffold only wires the routes defined in the project documentation.
        </p>
        <Link
          to="/stacks"
