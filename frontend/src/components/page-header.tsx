...
// The title is the screen's sole h1; sections inside the screen start at h2.
  ...
  return (
    <header className="flex flex-wrap items-end justify-between gap-3">
      <div className="min-w-0">
        ...
        <h1 className="mt-1 text-2xl font-semibold tracking-[-0.04em] text-[var(--text)]">{title}</h1>
