import { Activity, FolderCog, FolderKanban, LogOut, Monitor, Settings } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen">
      <div className="mx-auto flex min-h-screen max-w-[1600px] gap-4 px-4 py-4 md:px-6">
        <aside className="hidden w-56 shrink-0 rounded-[28px] border border-[var(--panel-border)] bg-[var(--panel)] p-4 shadow-[var(--shadow)] lg:flex lg:flex-col">
          <div className="mb-8">
